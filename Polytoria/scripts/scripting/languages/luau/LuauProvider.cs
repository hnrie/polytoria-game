	...
	public void PushValueToLua(LuaState state, object? value)
	{
		...
		switch (value)
		{
			...
			case byte[] byteArrayVal:
				...
				break;
			case object _ when valType != null && valType.IsEnum: // Handle enums
			...
			case IScriptObject sc: // Handle script objects
				...
				break;
			case object o when _gdToProxy.TryGetValue(o.GetType(), out MethodInfo? fromGDClass): // Handle proxies
